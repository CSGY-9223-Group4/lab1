...
class NoteService:
    ...
    def get_notes(self, author_id: int, page: int = 1, page_size: int = 10) -> Sequence[Note]:
    ...
    def update_note(self, 
        ...
        return self.notes_db.update_note(note_id, note_title, note_text, author_id, is_public)
